...
namespace DSharpPlusPlus.Tools.CodeBlockLanguageListGen;

public static class Program
{
    private static readonly string templateFile = new StreamReader(typeof(Program)
        .Assembly
        .GetManifestResourceStream("DSharpPlusPlus.Tools.CodeBlockLanguageListGen.FromCodeAttribute.LanguageList.template")
    ...
    public static async Task Main()
    {
        ...
        File.WriteAllText($"./DSharpPlusPlus.Commands/ParameterModifiers/FromCode/FromCodeAttribute.LanguageList.cs", templateFile
