...
namespace DSharpPlusPlus.Analyzers.Core;
...
public class UseDiscordPermissionsAnalyzer : DiagnosticAnalyzer
{
    ...
    private static void AnalyzeBitOp(SyntaxNodeAnalysisContext ctx)
    {
        ...
        bool leftTypeIsDiscordPermission
            = ctx.Compilation.CheckByName(leftTypeInfo, "DSharpPlusPlus.Entities.DiscordPermission");
        bool rightTypeIsDiscordPermission
            = ctx.Compilation.CheckByName(rightTypeInfo, "DSharpPlusPlus.Entities.DiscordPermission");
        bool leftTypeIsDiscordPermissions
            = ctx.Compilation.CheckByName(leftTypeInfo, "DSharpPlusPlus.Entities.DiscordPermissions");
        bool rightTypeIsDiscordPermissions
            = ctx.Compilation.CheckByName(rightTypeInfo, "DSharpPlusPlus.Entities.DiscordPermissions");
