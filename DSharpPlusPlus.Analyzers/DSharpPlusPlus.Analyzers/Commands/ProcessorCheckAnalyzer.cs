...
namespace DSharpPlusPlus.Analyzers.Commands;
...
public class ProcessorCheckAnalyzer : DiagnosticAnalyzer
{
    ...
    private static readonly Dictionary<string, string[]> allowedContexts
        ...
        {
            {
                "DSharpPlusPlus.Commands.Processors.TextCommands.CommandContext",
                ["UserCommandProcessor", "SlashCommandProcessor", "TextCommandProcessor"]
            },
            {
                "DSharpPlusPlus.Commands.Processors.SlashCommands.SlashCommandContext",
                ["UserCommandProcessor", "SlashCommandProcessor"]
            },
            { "DSharpPlusPlus.Commands.Processors.UserCommands.UserCommandContext", ["UserCommandProcessor"] },
            { "DSharpPlusPlus.Commands.Processors.TextCommands.TextCommandContext", ["TextCommandProcessor"] },
            { "DSharpPlusPlus.Commands.Processors.UserCommands.MessageCommandContext", ["MessageCommandProcessor"] },
        };
    ...
    private void Analyze(SyntaxNodeAnalysisContext ctx)
    {
        ...
        foreach (AttributeSyntax attribute in attributes)
        {
            ...
            if (namedTypeSymbol.ContainingNamespace.ToDisplayString() != "DSharpPlusPlus.Commands.Trees.Metadata")
            {
                continue;
            }
