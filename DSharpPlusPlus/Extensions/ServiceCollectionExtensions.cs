...
{
    /// <summary>
    /// Adds DSharpPlusPlus' DiscordClient and all its dependent services to the service collection.
    /// </summary>
    ...
    )
    {
        ...
        services.AddDSharpPlusPlusDefaultsSingleShard(intents);
        return services;
    }

    /// <summary>
    /// Adds DSharpPlusPlus' DiscordClient and all its dependent services to the service collection, initialized
    ...
    {
        services.Configure<TokenContainer>(c => c.GetToken = () => token);
        services.AddDSharpPlusPlusDefaultsMultiShard(intents);
        return services;
    }

    /// <summary>
    /// Forces DSharpPlusPlus to use zlib compression for the gateway.
    /// </summary>
    ...
    /// <summary>
    /// Forces DSharpPlusPlus to use zstd compression for the gateway.
    /// </summary>
    /// <param name="services">The service collection to configure this for.</param>
    /// <returns>The current instance for chaining.</returns>
    ...
    /// <summary>
    /// Forces DSharpPlusPlus to disable gateway compression entirely.
    /// </summary>
    /// <param name="services">The service collection to configure this for.</param>
    /// <returns>The current instance for chaining.</returns>
