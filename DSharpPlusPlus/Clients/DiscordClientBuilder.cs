...
using DSharpPlusPlus.Extensions;
using DSharpPlusPlus.Logging;
...
public sealed class DiscordClientBuilder
{
    ...
    )
    {
        ...
        builder.serviceCollection.AddDSharpPlusPlusDefaultsSingleShard(intents);
    ...
    /// </summary>
    /// <remarks>
    /// DSharpPlusPlus supports more advanced sharding over just specifying the amount of shards, which can be accessed
    ...
    )
    {
        ...
        builder.serviceCollection.Configure<TokenContainer>(x => x.GetToken = () => token);
        builder.serviceCollection.AddDSharpPlusPlusDefaultsMultiShard(intents);
    ...
    /// <summary>
    /// Disables the DSharpPlusPlus default logger for this DiscordClientBuilder.
    /// </summary>
    /// <returns>The current instance for chaining.</returns>
    ...
    /// <summary>
    /// Configures logging for this DiscordClientBuilder and disables the default DSharpPlusPlus logger.
    /// </summary>
    ...
    /// <summary>
    /// Configures the rest client used by DSharpPlusPlus.
    /// </summary>
    ...
    /// <summary>
    /// Configures the gateway client used by DSharpPlusPlus.
    /// </summary>
    ...
    /// <summary>
    /// Configures the sharding attempted by DSharpPlusPlus. Throws if the builder was not set up for sharding.
    /// </summary>
    ...
    /// <summary>
    /// Instructs DSharpPlusPlus to try reconnecting when encountering a fatal gateway error. By default, DSharpPlusPlus will
