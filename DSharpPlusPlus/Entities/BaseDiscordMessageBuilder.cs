...
/// <summary>
/// An abstraction for the different message builders in DSharpPlusPlus.
/// </summary>
    ...
    // This has got to be the most big brain thing I have ever done with interfaces lmfao
{
    ...
    public string? Content
    {
        ...
        set
        {
            ...
            SetIfV2Disabled(ref field, value, nameof(this.Content));
        }
    }
    ...
    {
        const int cv2MaxTotalComponents = 40;
        bool isCv2 = this.Flags.HasFlag(DiscordMessageFlags.IsComponentsV2);
        int maxTopComponents = isCv2 ? cv2MaxTotalComponents : 5;
        int maxAllComponents = isCv2 ? cv2MaxTotalComponents : 25;
