...
public class DiscordThreadChannelMember
{
    ...
    public DiscordMember Member
        => this.Guild != null ? this.Guild.members.TryGetValue(this.Id, out DiscordMember? member) ? member : new DiscordMember { Id = this.Id, guildId = this.guildId, Discord = this.Discord } : null;
