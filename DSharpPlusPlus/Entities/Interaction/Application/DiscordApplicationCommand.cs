...
public sealed partial class DiscordApplicationCommand : SnowflakeObject, IEquatable<DiscordApplicationCommand>
{
    ...
    /// <param name="nameLocalizations">Localization dictionary for <paramref name="name"/> field. Values follow the same restrictions as <paramref name="name"/>.</param>
    /// <param name="descriptionLocalizations">Localization dictionary for <paramref name="description"/> field. Values follow the same restrictions as <paramref name="description"/>.</param>
