...
public sealed class DiscordApplicationCommandOption
{
    ...
    /// <param name="nameLocalizations">Name localizations for this parameter.</param>
    /// <param name="descriptionLocalizations">Description localizations for this parameter.</param>
