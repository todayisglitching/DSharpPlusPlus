...
public sealed class GatewayClient : IGatewayClient
{
    ...
    )
    {
        ...
        this.logger = factory.CreateLogger("DSharpPlusPlus.Net.Gateway.IGatewayClient - invalid shard");
    }
    ...
    )
    {
        ...
        this.logger = shardInfo is null
            ? this.factory.CreateLogger("DSharpPlusPlus.Net.Gateway.IGatewayClient")
            : this.factory.CreateLogger($"DSharpPlusPlus.Net.Gateway.IGatewayClient - Shard {shardInfo.ShardId}");
