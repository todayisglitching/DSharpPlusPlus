...
public readonly struct AudioFormat
{
    ...
    /// </summary>
    public static IReadOnlyList<int> AllowedSampleRates { get; } = [8000, 12000, 16000, 24000, 48000];

    /// <summary>
    /// Gets the collection of channel counts the Opus encoder can use.
    /// </summary>
    public static IReadOnlyList<int> AllowedChannelCounts { get; } =[1, 2];

    /// <summary>
    /// Gets the collection of sample durations (in ms) the Opus encoder can use.
    /// </summary>
    public static IReadOnlyList<int> AllowedSampleDurations { get; } = [5, 10, 20, 40, 60];
