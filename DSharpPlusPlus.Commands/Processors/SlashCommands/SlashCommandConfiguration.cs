using DSharpPlusPlus.Commands.Processors.SlashCommands.InteractionNamingPolicies;
using DSharpPlusPlus.Commands.Processors.SlashCommands.RemoteRecordRetentionPolicies;
...
public sealed class SlashCommandConfiguration
{
    ...
    /// <summary>
    /// Instructs DSharpPlusPlus to always overwrite the command records Discord has of our bot on startup.
    /// </summary>
    /// <remarks>
    ...
    /// <summary>
    /// Controls when DSharpPlusPlus deletes an application command that does not have a local equivalent.
    /// </summary>
    /// <remarks>
