...
using DSharpPlusPlus.Commands.EventArgs;
using DSharpPlusPlus.Commands.Exceptions;
using DSharpPlusPlus.Commands.Processors;
...
using DSharpPlusPlus.Commands.Processors.TextCommands.ContextChecks;
...
<
    object,
    DSharpPlusPlus.Commands.ContextChecks.ContextCheckAttribute,
    DSharpPlusPlus.Commands.CommandContext,
...
<
    object,
    DSharpPlusPlus.Commands.ContextChecks.ParameterChecks.ParameterCheckAttribute,
    DSharpPlusPlus.Commands.ContextChecks.ParameterChecks.ParameterCheckInfo,
    DSharpPlusPlus.Commands.CommandContext,
    System.Threading.Tasks.ValueTask<string?>
>;
...
public sealed class CommandsExtension
{
    ...
    // See https://github.com/DSharpPlusPlus/DSharpPlusPlus/pull/2273#discussion_r2009114568 for more information.
    ...
    public void AddChecks(Assembly assembly)
    {
        ...
        {
            if (t.GetInterface("DSharpPlusPlus.Commands.ContextChecks.IContextCheck`1") is not null)
            {
                AddCheck(t);
            }
        }
    ...
    public void AddCheck(Type checkType)
    {
        ...
        {
            if (t.Namespace != "DSharpPlusPlus.Commands.ContextChecks" || t.Name != "IContextCheck`1")
            {
                continue;
            }
    ...
    public void AddParameterChecks(Assembly assembly)
    {
        foreach (Type t in assembly.GetTypes())
        {
            if (t.GetInterface("DSharpPlusPlus.Commands.ContextChecks.ParameterChecks.IParameterCheck`1") is not null)
            {
                AddParameterCheck(t);
            }
        }
    ...
    public void AddParameterCheck(Type checkType)
    {
        ...
        foreach (Type t in checkType.GetInterfaces())
        {
            if (t.Namespace != "DSharpPlusPlus.Commands.ContextChecks.ParameterChecks" || t.Name != "IParameterCheck`1")
            {
                continue;
            }
